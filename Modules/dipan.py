class Di_Pan():
    ...
    def get_ganzhi(self):
        ...
        zhi_dict = {'1':'子','2':'丑','3':'寅','4':'卯','5':'辰','6':'巳','7':'午','8':'未','9':'申','10':'酉','11':'戌','12':'亥'}
        print('请输入干支日:<int> <int>\n1:甲2:乙3:丙4:丁5:戊6:己7:庚8:辛9:壬10:癸\n1:子2:丑3:寅4:卯5:辰6:巳7:午8:未9:申10:酉11:戌12:亥')
        ganzhi = simple_input().split(' ')
    ...
    def qi_ju(self):
        ...
        yuan_check = {'甲子':'上元','乙丑':'上元','丙寅':'上元','丁卯':'上元','戊辰':'上元',
    ...
    def fortune_judge(self):
        sheng_Ke = {'金': {'金': 2, '木': -1, '水': 0, '火': -2, '土': 1}, 
                    ...
                    '火': {'金': -1, '木': 1, '水': -2, '火': 2, '土': 0}, 
                    '土': {'金': 0, '木': -2, '水': -1, '火': 1, '土': 2}}  
        ...
        result = {2:'大吉',1:'小吉',0:'小凶',-1:'小凶',-2:'大凶'}
        final = {4:'大吉',3:'大吉',2:'大吉',1:'小吉',0:'一般',-1:'小凶',-2:'大凶',-3:'大凶',-4:'大凶'}
        ...
        print('###日干与九宫的凶吉:{0}\n###日干与月份的凶吉:{1}\n###最终凶吉为:{2}'\
              .format(result[self.res[0]],result[self.res[1]],final[self.res[0] + self.res[1]]))
